...
const ModalTop = () => {
  ...
  return (
    <div className="Modal">
      <Container>
        <Wrapper>
          {disableSelector?.avatarProfile === false && (
            <ModeInterface typeShowMode={show.showMode}>
              ...
              <Items onClick={handleShowMode}>
                <Item>
                  ...
                  Giao diện:{" "}
                  {modeSelector.modeDark.feature === true
                    ? modeSelector.modeDark.name
                    : "Sáng"}
                </Item>
                <KeyboardArrowRightOutlinedIcon />
              </Items>
          ...
          {disableSelector?.streamProfile === false && (
            <>
      ...
      {show.showMode === true && (
        <InterfaceMode show={show} setShow={setShow} />
      )}
    </div>
  );
};
